          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form action="bModify" method="POST" name="bModifyForm" enctype="multipart/form-data">
                    <input type="hidden" name="boNum" value="${modify.boNum}">
 					<input type="hidden" name="boFilename" value="${modify.boFileName}">
                    
                    <!-- 아이디 -->
                    <div class="input-group input-group-outline mb-3">
                      <input type="hidden" name="boWriter" value="${loginId}">${loginId}
                    </div>
                    
					<!-- 글제목 -->
                    <div class="input-group input-group-outline mb-3">
                      제목 <input type="text" name="boTitle" size="42" style="outline-color: #FE6B8B;" placeholder="${modify.boTitle}">
                    </div>
                    
					<!-- 글내용 -->
                    <div class="input-group input-group-outline mb-3">
                     내용 <textarea name="boContent" placeholder="${modify.boContent}" size="200"></textarea>
                    </div>

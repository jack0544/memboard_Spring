                ...
                <div class="card-body">
                  <form action="mJoin" method="POST" name="joinForm" enctype="multipart/form-data">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      <input type="text" class="form-control" id="memId" name="memId" onkeyup="checkId()" style="outline-color: #FE6B8B;" placeholder="아이디" />
                    </div>
                    <span id="check1"></span>
					<!-- 비밀번호 -->
                    <div class="input-group input-group-outline mb-3">
                      <input type="password" class="form-control" name="memPw" id="memPw" onkeyup="pwRegexp()" style="outline-color: #FE6B8B;" placeholder="비밀번호" />
                    </div>
                    <span id="pwResult1"></span>
					<!-- 비밀번호 확인 -->
                    <div class="input-group input-group-outline mb-3">
                      <input type="password" class="form-control" id="checkPw" onkeyup="pwCheck()" style="outline-color: #FE6B8B;" placeholder="비밀번호 확인" />
                    </div>
                    <span id="pwResult2"></span>
					<!-- 이름 -->
                    <div class="input-group input-group-outline mb-3">

                      <input type="text" class="form-control" id="memName" name="memName" onkeyup="nameRegexp()" style="outline-color: #FE6B8B;" placeholder="이름" />
                    </div>
                    ...
                    <div class="input-group input-group-outline mb-3">
  						...
  						남자&nbsp;<input type="radio" name="memGender" value="남성" style="outline-color: #FE6B8B;" />						
						&nbsp;여자&nbsp;<input type="radio" name="memGender" value="여성" style="outline-color: #FE6B8B;" />		
                    </div>
					<!-- 이메일 -->
                    <div class="input-group input-group-outline mb-3">

                      <input type="email" class="form-control"  id="memEmail" name="memEmail" style="outline-color: #FE6B8B;" placeholder="이메일" />
                    
                    </div>
                    <div class="input-group input-group-outline mb-3">
                    <span id="confEmail"><input type="button" style="outline-color: #FE6B8B;" value="인증번호 발송" onclick="checkEmail()"/></span>
					</div>
					
					<!-- 연락처 -->
                    <div class="input-group input-group-outline mb-3">

                      <input type="text" class="form-control" name="memPhone" style="outline-color: #FE6B8B;" placeholder="연락처" />
                    </div>
					<!-- 주소 -->
                    <div class="input-group input-group-outline mb-3">
                    
                    <input type="text" class="form-control" name="addr1" id="sample6_postcode" style="outline-color: #FE6B8B;" placeholder="우편번호">
					<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>     
                    </div>
                    <div class="input-group input-group-outline mb-3">
					<input type="text" class="form-control" name="addr2" size="40" id="sample6_address" style="outline-color: #FE6B8B;" placeholder="주소"><br>
					
                    
                    </div>
                    <div class="input-group input-group-outline mb-3">     
					<input type="text" class="form-control" name="addr3" size="40" id="sample6_detailAddress" style="outline-color: #FE6B8B;" placeholder="상세주소">
                    ...
                    <div class="text-center">
                      <input type="button" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" onclick="checkConfirm()" value="가입" />
                    </div>
                  </form>
                </div>
...
function checkEmail(){
	...
	$.ajax({
		...
		success : function(uuid){
			...
			$("#confEmail").html("<input type='text' id='uuidCheck' placeholder='인증번호'/>"
